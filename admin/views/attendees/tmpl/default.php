...
<form action="<?php echo JRoute::_('index.php?option=com_jem&view=attendees'); ?>"  method="post" name="adminForm" id="adminForm">
	<table class="adminlist">
		...
		<div class="btn-wrapper">
				...
				<div class="btn"><a title="<?php echo JText::_('COM_JEM_CSV_EXPORT'); ?>" onclick="window.open('index.php?option=com_jem&amp;task=attendees.export&amp;tmpl=raw&amp;id=<?php echo $this->event->id; ?>')"><?php echo JText::_('COM_JEM_CSV_EXPORT'); ?></a></div>
			</div>
			</td>
		</tr>
	</table>
		...
		<tr>
			<td width="100%">
				...
				<div class="btn-wrapper input-append">
					...
					<button class="btn" type="submit" onclick="document.getElementById('filter_search').value='';this.form.submit();"><i class="icon-search"></i></button>
				</div>
			</td>
	...
	<table class="table table-striped" id="eventList">
		<thead>
			<tr>
				...
				<th class="title"><?php echo JHtml::_('searchtools.sort', 'COM_JEM_NAME', 'u.name', $this->lists['order_Dir'], $this->lists['order']); ?></th>
				<th class="title"><?php echo JHtml::_('searchtools.sort', 'COM_JEM_USERNAME', 'u.username', $this->lists['order_Dir'], $this->lists['order']); ?></th>
				<th class="title"><?php echo JText::_('COM_JEM_EMAIL'); ?></th>
				<th class="title"><?php echo JText::_('COM_JEM_IP_ADDRESS'); ?></th>
				<th class="title"><?php echo JHtml::_('searchtools.sort', 'COM_JEM_REGDATE', 'r.uregdate', $this->lists['order_Dir'], $this->lists['order']); ?></th>
				<th class="title center"><?php echo JHtml::_('searchtools.sort', 'COM_JEM_USER_ID', 'r.uid', $this->lists['order_Dir'], $this->lists['order']); ?></th>
				<?php if ($this->event->waitinglist): ?>
